...
class Command(BaseCommand):
    args = ''
    help = 'Build databases for the experimental setup used in 2017 UNSW experiment, short version'

    def handle(self, *args, **options):
        # Create the scenario
        ss = Scenario(description= 'UNSW 2017 vibrato perception experiment - short version for testing',
