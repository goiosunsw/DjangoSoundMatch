...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        itemdata = ({'model': Page,
                    ...
                    {'model': Experiment,
                     'instruction_text': 'Adjust tone 2 so that it sounds as loud as tone 1',
                    ...
                    {'model': Experiment,
                     ...
                     {'model': Experiment,
                      'instruction_text': 'Adjust tone 2 so that it sounds twice as loud as tone 1',
                    ...
                    {'model': 'Repeat',
                     ...
                     {'model': Experiment,
                      ...
                      'instruction_text': 'Adjust tone 2 so that it sounds twice as bright as tone 1',
                      'design': 'soundadjustpage',
